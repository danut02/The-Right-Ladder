...
public class PlayerController : MonoBehaviour
{
	...
	private void TppCameraRotation()
    {
        // Update _inputLook based on mouse input
    ...
    private void Update()
    {
    	...
    	// Use _cinemachineTargetYaw for the horizontal direction
    	Quaternion cameraRotation = Quaternion.Euler(0, _cinemachineTargetYaw, 0);

    	// Calculate desiredMoveDir based on the camera's yaw
    	desiredMoveDir = cameraRotation * moveInput;
    ...
    public IEnumerator DoAction(string animName, MatchTargetParams matchParams=null,
        Quaternion targetRotation=new Quaternion(), bool rotate=false, float postDelay=0f, bool mirror=false)
    {
        InAction = true;
